...
void 記錄多空價格()
{
    ...
    //寫入資料
    string 訊息 = StringConcatenate("AskRec:", Ask紀錄, ",BidRec:", Bid紀錄);
...
int OnInit()
{
    ...
    string 訊息 = StringConcatenate("程式啟動時，多單倉數:", longLots, "、", "空單倉數:", shortLots, "。", "MAGIC_NUMBER:", MAGIC_NUMBER);
    紀錄LOG(訊息);
